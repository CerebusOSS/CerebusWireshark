...
local CbPktChanInfo = CbPktConfig:new('cbPKT_CHANINFO',
    {
        ...
        PktField:new{t='STRING', n='physcalin.anaunit', d='unit label', len=cbConst.cbLEN_STR_UNIT},
        ...
        PktField:new{t='STRING', n='scalin.anaunit', d='unit label', len=cbConst.cbLEN_STR_UNIT},
        ...
        PktField:new{t='STRING', n='scalout.anaunit', d='unit label', len=cbConst.cbLEN_STR_UNIT},
...
local CbPktChanReset = CbPktConfig:new('cbPKT_CHANRESET',
    {
        ...
        PktField:new{t='UINT8', n='moninst', d="Reset monitor instrument", valuestring={[0]='no', [1]='yes'}},
        PktField:new{t='UINT8', n='monchan', d="Reset monitor channel", valuestring={[0]='no', [1]='yes'}},
...
local CbPktPrevStreamCfg = CbPktPrevStreamBase:new('prevStreamCfg',
    {
        _types={
            ...
            [0x0084] = "Cfg Prev Stream Request cbPKTTYPE_PREVSETLNC",
...
local CbPktLog = CbPktConfig:new('cbPKT_LOG',
    {
        ...
        PktField:new{t='STRING', n='desc', len=130},
        _types={
